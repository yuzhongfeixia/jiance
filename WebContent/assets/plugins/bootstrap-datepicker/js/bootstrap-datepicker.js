...
!function( $ ) {
					...
					case 'th':
						switch(target[0].className) {
							...
							case 'today':
								...
								this.showMode(-2);
								var which = this.o.todayBtn ? 'date' : 'view';
	...
	var DPGlobal = {
		...
		footTemplate: '<tfoot><tr><th colspan="3" class="today"></th><th style="background:none!important;cursor: default;"></th><th colspan="3" class="clear"></th></tr></tfoot>'
	};
