...
(function (factory) {
    ...
    $.widget('blueimp.fileupload', $.blueimp.fileupload, {
        ...
        _getFilesFromResponse: function (data) {
            // 为了配合AjaxJson对象，修改成从attribute中取值
            if (data.result.attributes && $.isArray(data.result.attributes.files)) {
                return data.result.attributes.files;
            }
            return [];
        },
        ...
        _hasError: function (file) {
            ...
            if (this.options.maxFileSize &&
                ...
                return '文件过大，必须小于等于' + this.options.maxFileSize;
            }
            if (typeof file.size === 'number' &&
                    file.size < this.options.minFileSize) {
                return '文件过小，必须大于等于' + this.options.minFileSize;
            }
            return null;
        },
