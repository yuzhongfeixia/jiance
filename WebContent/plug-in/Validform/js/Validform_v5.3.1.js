...
(function($,win,undef){
	...
	Validform.util={
		...
		check:function(curform,brothers,subpost,bool,async){
			/*
				检测单个表单元素;
	...
	Validform.prototype={
		...
		checkAll:function(bool, async, selector){
			/*
			bool：传入true，只检测不显示提示信息;
			*/
			...
			curform.find(selector).each(function(){
				Validform.util.check.call(this,curform,obj,"",bool,async) || (flag=false);
			});
	...
	$.fn.Validform=function(settings){
		var validator = new Validform(this, settings);
