		...
		success : function(data) {
				...
				if (jsonData.success) {
					$.each(jsonData.attributes.resultMap, function(index, item){
						...
						s += 
						"<td height=\"29\" class=\"font_grey\">" + toString(item.ORDERNO) + "</td>"+
						"<td class=\"font_grey\">" + toString(item.NAME) + "</td>"+
						"<td class=\"font_grey\">" + toString(item.POSITIONALTITLE) + "</td>"+
						"<td class=\"font_grey\">" + toString(item.DUTY) + "</td>"+
						"<td class=\"font_grey\">" + toString(item.UNIT) + "</td>"+
						"<td class=\"font_grey\">" + toString(item.ORIENTATION) + "</td>"+
						"</tr>";
					});
					$("#tb").html(s.toString());
				}
	...
	<div class="main_right">
		<ul>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr bgcolor="#08822b">
					<td height="29" class="font_white">序号</td>
					<td class="font_white">姓名</td>
					<td class="font_white">职称</td>
					<td class="font_white">职务</td>
					<td class="font_white">单位</td>
					<td class="font_white">研究方向</td>
				</tr>
