	...
	<script>
		...
		function getDataTable(projectCode) {
			$.ajax({
				async: false,
				type : 'POST',
				url : 'livestockSituationController.do?getCityLiveStockSitu',
		...
		function drewTableCells(htmls, headerSize){
			...
			// 设定table的单元格数
			$('#staticts_table').css({"width" : (300 * headerSize + 1000) + 'px'});
...
function doExportExcel(){
	...
	exportExcelByCustom('report.LivestockPlantSituationService.getCommonLiveStockSituExport','','searchConditionForm');
}
</script> 
</body>
</html>
