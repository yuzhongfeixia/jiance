...
<!-- 							<a class="btn btngroup_usual" onclick="exportExcelByCustom('report.LivestockPlantSituationService.exportMonitor','','searchConditionForm')">导出Excel<i class="icon-share"></i></a> -->
	...
	<script>
		...
		function getDataTable(projectCode) {
			$.ajax({
				async: false,
				type : 'POST',
				url : 'livestockSituationController.do?getTableMonitor',
...
// 			htmls += '<th class="center hidden-480" colspan="1" rowspan="2" style="vertical-align: middle !important">县(市/区)</th>';
