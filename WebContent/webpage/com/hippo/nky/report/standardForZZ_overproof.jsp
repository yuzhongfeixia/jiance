...
function exportExcel_sfzzop(){
	...
	exportExcelByCustom('report.PlantSituationService.exportOverProof','','searchConditionForm');
}
</script>
</head>
...
<!-- 									</select> -->
					...
					<div class="clearfix" >
						<div class="pull-right">
							...
							<a class="btn btngroup_usual" onclick="exportExcel_sfzzop();">导出Excel<i class="icon-share"></i></a>
						</div>
					</div>
	...
	<script>
		...
		function getDataTable(projectCode) {
			$.ajax({
				async: false,
				type : 'POST',
				url : 'plantSituationController.do?getTableOverProof',
