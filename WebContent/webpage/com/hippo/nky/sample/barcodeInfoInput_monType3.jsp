...
<!-- 										</select> -->
						...
						<tr>
							...
							<td class="value">
								<div class="value-elems">
									<input  name="generalcheckEntity.tradeMark" type="text" class="m-wrap small" datatype="*" ignore="ignore" value="${barcodeInfoInputPage.generalcheckEntity.tradeMark}"/>
								</div>
							</td>
							<td class="title">
								<div class="title-label">
							...
							<td class="value">
								<div class="value-elems">
									<ul class="line">
										<li class="elemet"><input  type="radio" name="generalcheckEntity.pack" value="1" <c:if test="${barcodeInfoInputPage.generalcheckEntity.pack eq '1'}">checked</c:if>/>有</li>
										<li class="elemet"><input  type="radio" name="generalcheckEntity.pack" value="0" <c:if test="${barcodeInfoInputPage.generalcheckEntity.pack eq '0'}">checked</c:if>/>无</li>
									</ul>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td class="value">
								<div class="value-elems">
									<input  name="generalcheckEntity.grade" type="text" class="m-wrap small" datatype="*" ignore="ignore" value="${barcodeInfoInputPage.generalcheckEntity.grade}"/>
								</div>
							</td>
							<td class="title">
								<div class="title-label">
							...
							<td class="value">
								<div class="value-elems">
									<ul class="line">
										<li class="elemet"><input  type="radio" name="generalcheckEntity.flag" value="1" <c:if test="${barcodeInfoInputPage.generalcheckEntity.flag eq '1'}">checked</c:if>/>有</li>
										<li class="elemet"><input  type="radio" name="generalcheckEntity.flag" value="0" <c:if test="${barcodeInfoInputPage.generalcheckEntity.flag eq '0'}">checked</c:if>/>无</li>
									</ul>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td class="value">
								<div class="value-elems">
									<input  name="generalcheckEntity.specifications" type="text" class="m-wrap small" datatype="*" ignore="ignore" value="${barcodeInfoInputPage.generalcheckEntity.specifications}"/>
								</div>
							</td>
							<td class="title">
								<div class="title-label">
							...
							<td class="value">
								<div class="value-elems">
									<input  name="generalcheckEntity.execStandard" type="text" class="m-wrap small" datatype="*" ignore="ignore" value="${barcodeInfoInputPage.generalcheckEntity.execStandard}"/>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td class="value" colspan="3">
								<div class="value-elems">
									<input  name="generalcheckEntity.batchNumber" type="text" class="m-wrap" datatype="*" ignore="ignore" value="${barcodeInfoInputPage.generalcheckEntity.batchNumber}"/>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td class="value" colspan="3">
								<div class="value-elems">
									<t:dictSelect id="productCer" field="generalcheckEntity.productCer" typeGroupCode="productCer" hasLabel="false" defaultVal="${barcodeInfoInputPage.generalcheckEntity.productCer}"></t:dictSelect>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td class="value">
								<div class="value-elems">
									<input name="generalcheckEntity.productCerNo" type="text" class="m-wrap" datatype="*" ignore="ignore" value="${barcodeInfoInputPage.generalcheckEntity.productCerNo}"/>
								</div>
							</td>
							<td class="title">
								<div class="title-label">
						...
						<tr>
							...
							<td class="value">
								<div class="value-elems">
									<input  name="generalcheckEntity.samplingCount" type="text" class="m-wrap small" value="${barcodeInfoInputPage.generalcheckEntity.samplingCount}"/>
								</div>
							</td>
							<td class="title">
								<div class="title-label">
							...
							<td class="value">
								<div class="value-elems">
									<input  name="generalcheckEntity.samplingCardinal" type="text" class="m-wrap small" value="${barcodeInfoInputPage.generalcheckEntity.samplingCardinal}"/>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td class="value">
								<div class="value-elems">
									<input class="m-wrap small m-ctrl-medium date-picker" id="samplingDate" type="text" name="samplingDate" value="<fmt:formatDate value='${barcodeInfoInputPage.samplingDate}' type='both' pattern='yyyy-MM-dd'/>" datatype="*" nullMsg="请选择！" readonly="readonly" onchange="checkself(this)"/>
								</div>
							</td>
						</tr>
					</table>
...
<%-- 								<input id="unitFullname" name="unitFullname" type="text" class="m-wrap" data-provide="typeahead" data-source="${nameSource}" --%>
<%-- 									 data-ids="${codeNameSource}" datatype="*" value="${barcodeInfoInputPage.unitFullname}" onblur="setAutoData()"/> --%>
						...
						<tr>
							...
							<td class="value" colspan="2">
								<input  name="generalcheckEntity.stall" type="text" class="m-wrap medium" style="width:150px" datatype="*" ignore="ignore" value="${barcodeInfoInputPage.generalcheckEntity.stall}"/>
							</td>
							<td class="title">
								<div class="title-label">
									<span>电话</span>
							...
							<td class="value">
								<input name="generalcheckEntity.telphone" type="text" class="m-wrap small" datatype="*" ignore="ignore" value="${barcodeInfoInputPage.generalcheckEntity.telphone}"/>
							</td>
							<td class="title">
								<div class="title-label">
									<span>传真</span>
							...
							<td class="value">
								<input  name="generalcheckEntity.fax" type="text" class="m-wrap small" datatype="*" ignore="ignore" value="${barcodeInfoInputPage.generalcheckEntity.fax}"/>
							</td>
						</tr>
						<tr>
							...
							<td class="value">
								<div class="value-elems">
									<ul class="line">
									<li class="elemet"><input  type="radio" name="generalcheckEntity.unitProperties" value="0" <c:if test="${barcodeInfoInputPage.generalcheckEntity.unitProperties eq '0'}">checked</c:if>/>生产</li>
									<li class="elemet"><input  type="radio" name="generalcheckEntity.unitProperties" value="1" <c:if test="${barcodeInfoInputPage.generalcheckEntity.unitProperties eq '1'}">checked</c:if>/>进货单位名称</li>
								</ul>
								</div>
							</td>
							<td class="value" colspan="5">
								<input name="generalcheckEntity.unitName" type="text" class="m-wrap" datatype="*" ignore="ignore" value="${barcodeInfoInputPage.generalcheckEntity.unitName}" />
							</td>
						</tr>
						<tr>
							<td class="title">
							...
							<td class="value" colspan="3">
								<div class="value-elems">
									<input  name="generalcheckEntity.unitAddress" type="text" class="m-wrap medium" datatype="*" ignore="ignore" value="${barcodeInfoInputPage.generalcheckEntity.unitAddress}"/>
								</div>
							</td>
							<td class="title">
								<div class="title-label">
							...
							<td class="value" colspan="2">
								<input  name="generalcheckEntity.zipCode" type="text" class="m-wrap small" datatype="/^\d{6}?$/" ignore="ignore" value="${barcodeInfoInputPage.generalcheckEntity.zipCode}"/>
							</td>
						</tr>
						<tr>
							<td class="title">
							...
							<td class="value">
								<div class="value-elems">
									<input  name="generalcheckEntity.contacts" type="text" class="m-wrap small" datatype="*" ignore="ignore" value="${barcodeInfoInputPage.generalcheckEntity.contacts}"/>
								</div>
							</td>
							<td class="title">
								<div class="title-label">
							...
							<td class="value">
								<input  name="generalcheckEntity.telphone2" type="text" class="m-wrap small" datatype="*" ignore="ignore" value="${barcodeInfoInputPage.generalcheckEntity.telphone2}"/>
							</td>
							<td class="title">
								<div class="title-label">
									<span>传真</span>
							...
							<td class="value">
								<input  name="generalcheckEntity.fax2" type="text" class="m-wrap small" datatype="*" ignore="ignore" value="${barcodeInfoInputPage.generalcheckEntity.fax2}"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="value" colspan="6">
								<input  name="generalcheckEntity.samplingNo" type="text" class="m-wrap medium" datatype="*" ignore="ignore" value="${barcodeInfoInputPage.generalcheckEntity.samplingNo}"/>
							</td>
						</tr>
					</table>
