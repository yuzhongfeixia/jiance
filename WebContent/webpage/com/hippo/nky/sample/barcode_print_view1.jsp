	...
	for (var i in Options)    
	{
		if(i%2 == 1){
			for (var j = 0; j < printCopies; j++) {
				...
				LODOP.ADD_PRINT_TEXT("5cm","2.4cm",120,120,"■"+Options[i]);	
			}
		}else{
			for (var j = 0; j < printCopies; j++) {
				LODOP.NewPage();
...
<iframe id="myiframe" name="myiframe" src="barcodePrintController.do?print&dcode=${dcode}" width="60%" height="400" > </iframe>
<div id="span2">
