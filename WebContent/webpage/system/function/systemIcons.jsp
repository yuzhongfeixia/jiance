...
.systemiconsDiv .unstyled li:hover{
  background: #c5c5c5;  
  cursor: pointer;
}
.unstyled li.systemIcon-selected{
	background: #c5c5c5;
}
</style>
<script>
$(".systemiconsDiv .unstyled li").on('click', function(e){
	$(".systemiconsDiv .unstyled li").each(function(){
		$(this).removeClass("systemIcon-selected");
	});
	$(e.target).addClass("systemIcon-selected");
});
function getSelectedIcon(data){
	var selectIcon = $(".systemIcon-selected i").attr("class");
	data.params["selectIcon"] = selectIcon;
	return data;
}
</script>
		...
		<div class="portlet box popupBox_usual">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="hidden-480">图标样式</span>
				</div>
			</div>
			<div class="portlet-body">
				<div class="systemiconsDiv">
					<div class="row-fluid">
						<div class="span12">
							<h3>常用图标</h3>
						</div>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn popenter" action-mode="ajax" action-operation="popsave" action-before="getSelectedIcon" action-after="${callback}">确定</button>
				</div>
			</div>
		</div>
	</div>
