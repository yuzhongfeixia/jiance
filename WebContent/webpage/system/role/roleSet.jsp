...
<%@include file="/webpage/common/scripts.jsp"%>
...
<script type="text/javascript">
	...
	function mysubmit() {
		...
		var s = GetNode();
		var jsonParam = {};
		jsonParam["targetUrl"] = 'roleController.do?updateAuthority';
		jsonParam["params"] = {"rolefunctions" : s , "roleId" : roleId};
	...
	function showUpdateAuthorityTips(){
		modalTips("权限更新成功");
	}
	function GetNode() {
...
<div  style="padding:1px;" fit="true" border="false" id="functionListPanel">
...
<div style="padding:1px;" fit="true" border="false" id="operationListpanel">
</div>
</div>
</div>
