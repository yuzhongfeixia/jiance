 ...
 */
@Entity
@Table(name = "nky_laboratory", schema = "")
@SuppressWarnings("serial")
public class LaboratoryEntity implements java.io.Serializable {
	/**机构编码*/
	...
	/**专业性风险评估实验室依托单位*/
	private java.lang.String professionalsupportunit;
	/**区域性风险评估实验室依托单位*/
	private java.lang.String regionalsupportunit;
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  专业性风险评估实验室依托单位
	 */
	@Column(name ="PROFESSIONALSUPPORTUNIT",nullable=true,length=32)
	public java.lang.String getProfessionalsupportunit(){
		return this.professionalsupportunit;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  专业性风险评估实验室依托单位
	 */
	public void setProfessionalsupportunit(java.lang.String professionalsupportunit){
		this.professionalsupportunit = professionalsupportunit;
	}
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  区域性风险评估实验室依托单位
	 */
	@Column(name ="REGIONALSUPPORTUNIT",nullable=true,length=32)
	public java.lang.String getRegionalsupportunit(){
		return this.regionalsupportunit;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  区域性风险评估实验室依托单位
	 */
	public void setRegionalsupportunit(java.lang.String regionalsupportunit){
		this.regionalsupportunit = regionalsupportunit;
	}
}
