 ...
 */
@Entity
@Table(name = "NKY_POLL_DICTIONARY", schema = "")
@SuppressWarnings("serial")
public class PollDictionaryEntity implements java.io.Serializable {
	/**污染物字典ID*/
	...
	/**结构式*/
	@Excel(exportName="结构式", exportConvertSign = 0, exportFieldWidth = 30, importConvertSign = 0)
	 ...
	 *@return: java.lang.String  污染物字典ID
	 */
	 ...
	 *@param: java.lang.String  污染物字典ID
	 */
...
//	@Transient
//	public String getSplitUse() {
//		if(this.use == null || this.use == ""){
//			return "";
//		}
//		String noHtmlContent = this.use.replaceAll("<[^>]*>","");
//		if(noHtmlContent.length() > 5) {
//			noHtmlContent = noHtmlContent.substring(0, 5) + "...";
//		}
//		return noHtmlContent;
//	}
//	
//	@Transient
//	public String getSplitPopename() {
//		if(this.popename == null || this.popename == ""){
//			return "";
//		}
//		String noHtmlContent = this.popename.replaceAll("<[^>]*>","");
//		if(noHtmlContent.length() > 10) {
//			noHtmlContent = noHtmlContent.substring(0, 10) + "...";
//		}
//		return noHtmlContent;
//	}
}
