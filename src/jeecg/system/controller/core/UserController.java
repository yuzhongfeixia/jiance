...
public class UserController {
	...
	public String user(HttpServletRequest request) {
		...
		String departsReplace = "";
		List<TSDepart> departList = systemService.getList(TSDepart.class);
		List<OrganizationEntity> orgList = systemService.getList(OrganizationEntity.class);
//		for (TSDepart depart : departList) {
//			if (departsReplace.length() > 0) {
//				departsReplace += ",";
//			}
...
//		return "system/user/changepassword";
	...
	@ResponseBody
	public AjaxJson checkPassword(HttpServletRequest request) {
		AjaxJson j = new AjaxJson();
		TSUser user = ResourceUtil.getSessionUserName();
	...
	public void datagrid(TSUser user,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		String userName = oConvertUtils.getString(request.getParameter("searchName"));
		...
		String departname = oConvertUtils.getString(request.getParameter("TSDepart.id"));
		String orgId = oConvertUtils.getString(request.getParameter("organization.id"));
		...
		if (!StringUtil.isEmpty(orgId)) {
			cq.in("TSDepart.id", new Object[]{orgId});
		}
...
//		cq.add();
		...
		TagUtil.dataTable(response, dataGrid,orgList);
	}

//	String fieldStr = "";
//	private String getClassField(Class cls,	String fieldStr) {
//		Field[] fields = cls.getDeclaredFields();
//		for (Field field : fields) {
//			if(field.getName().equals("TSDepart")){
//				fieldStr += field.getName() + "_departname,";
//			}else{
...
//			return getClassField(superclass,fieldStr);  
//		} 
//
//		return fieldStr;
//	}
...
//			v.setStatus("n");
	...
	public ModelAndView addorupdate(TSUser user, HttpServletRequest req) {
		String flag = oConvertUtils.getString(req.getParameter("flag"));
	...
	public void idandname(HttpServletRequest req, TSUser user) {
		...
		req.setAttribute("roleIds", roleId);
