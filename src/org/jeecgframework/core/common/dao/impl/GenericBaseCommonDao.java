...
public abstract class GenericBaseCommonDao<T, PK extends Serializable> extends SqlSessionDaoSupport implements IGenericBaseCommonDao {
	/**
	 * 初始化Log4j的一个实例
	 */
	 ...
	 * @param paramMap
	 */
	public void callProcByMyBatis(String paramString, Map<String, Object> param) {
		this.getSqlSession().selectList(paramString, param);
	}
	 ...
	 * @param paramObject
	 */
	public List<T> findListByMyBatis(String paramString, Object parameter) {
		return this.getSqlSession().selectList(paramString, parameter);
	}
	 ...
	 * @param paramObject
	 */
	public List<T> findListByMyBatis(String paramString, Object parameter, RowBounds rowBounds) {
		return this.getSqlSession().selectList(paramString, parameter,rowBounds);
	}
	 ...
	 * @return
	 */
	public int deleteByMyBatis(String paramString, Object parameter) {
		return this.getSqlSession().delete(paramString, parameter);
	}
	/**
	 * 批量删除数据
	 * @param paramString
	 ...
	 * @return
	 */
	public int deleteBatchByMyBatis(String paramString, List<?> list) {
		if ((list == null) || (list.isEmpty())) {
			return 0;
		}
		SqlSession sqlSession = this.getSqlSession();
		for (int i = 0; i < list.size(); ++i) {
			sqlSession.delete(paramString, list.get(i));
		}
		return list.size();
	}
	/**
	 ...
	 * @return
	 */
	public T getObjectByMyBatis(String paramString, Object parameter) {
		return this.getSqlSession().selectOne(paramString, parameter);
	}
	/**
	 * 插入数据
	 * @param paramString
	 ...
	 * @return
	 */
	public int insertByMyBatis(String paramString, Object parameter) {
		return this.getSqlSession().insert(paramString, parameter);
	}
	/**
	 * 批量插入数据
	 * @param paramString
	 ...
	 * @return
	 */
	public int insertBatchByMyBatis(String paramString, List<?> list) {
		if ((list == null) || (list.isEmpty())) {
			return 0;
		}
		SqlSession sqlSession = this.getSqlSession();
		for (int i = 0; i < list.size(); ++i) {
			sqlSession.insert(paramString, list.get(i));
		}
		return list.size();
	}
	/**
	 ...
	 * @return
	 */
	public Map<?, T> selectMapByMyBatis(String paramString, Object parameter, String mapKey) {
		return this.getSqlSession().selectMap(paramString, parameter, mapKey);
	}
	/**
	 * 更新数据
	 * @param paramString
	 ...
	 * @return
	 */
	public int updateByMyBatis(String paramString, Object parameter) {
		return this.getSqlSession().update(paramString, parameter);
	}
	/**
	 * 批量更新数据
	 * @param paramString
	 ...
	 * @return
	 */
	public int updateBatchByMyBatis(String paramString, List<?> list) {
		if ((list == null) || (list.isEmpty())) {
			return 0;
		}
		SqlSession sqlSession = this.getSqlSession();
		for (int i = 0; i < list.size(); ++i) {
			sqlSession.update(paramString, list.get(i));
		}
		return list.size();
	}
