...
public interface CommonService {
	 ...
	 * @return
	 */
	public <T> Map<?, T> selectMapByMyBatis(String nameSpace, Object paramObject, String paramString2);
	 ...
	 * 
	 * @param code 区域代码
	 * @param flg 是否加载当前地区下所有地区
	 * @return List<SysAreaCodeEntity>
	 */
	 ...
	 * @return
	 */
	public void setUserDataPriv(String projectCode, Map<String, Object> selCodition);
}
